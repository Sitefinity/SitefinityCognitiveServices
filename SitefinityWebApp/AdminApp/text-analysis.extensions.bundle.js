...
var TextAnalysisComponent = /** @class */ (function () {
    ...
    TextAnalysisComponent.prototype.ngOnInit = function () {
        ...
        var taxContainer = document.querySelectorAll("[ng-reflect-name='Tags']")[0];
        if (taxContainer) {
            var tagsEl = taxContainer.querySelectorAll("sf-taxa")[0];
            this.tagsFixture = ng.probe(tagsEl);
        }
        var categoryContainer = document.querySelectorAll("[ng-reflect-name='Category']")[0];
        if (categoryContainer) {
            var categoryEl = categoryContainer.querySelectorAll("sf-taxa")[0];
            this.categoryFixture = ng.probe(categoryEl);
        }
    };
    TextAnalysisComponent.prototype.onAddSummary = function (e) {
    ...
    TextAnalysisComponent.prototype.onAddTag = function (e, tagText) {
        if (this.tagsFixture) {
            this.tagsFixture.componentInstance.onTaxaEntered(tagText);
            this.setCheckMark(e);
        }
    };
    TextAnalysisComponent.prototype.onAddCategory = function (e, categorySugestion) {
        if (this.categoryFixture) {
            this.categoryFixture.componentInstance.onTaxaEntered(categorySugestion.Label);
            this.setCheckMark(e);
        }
    };
    TextAnalysisComponent.prototype.onAnalyzeClick = function () {
        var _this = this;
    ...
    TextAnalysisComponent.prototype.setCheckMark = function (e) {
    ...
    TextAnalysisComponent.prototype.getHashtags = function (text) {
        var url = this.serviceUrl + "/webapi/CognitiveServices/Hashtags";
    ...
    TextAnalysisComponent.prototype.getSentiment = function (text) {
        var url = this.serviceUrl + "/webapi/CognitiveServices/Sentiment";
        return this.http.post(url, JSON.stringify({ "Text": text }), { headers: new http_1.HttpHeaders({ 'Content-Type': 'application/json' }) });
    };
    TextAnalysisComponent.prototype.getSummary = function (title, text, sentencesNumber) {
        var url = this.serviceUrl + "/webapi/CognitiveServices/Summarize";
    ...
    TextAnalysisComponent.prototype.getCategories = function (text) {
        var url = this.serviceUrl + "/webapi/CognitiveServices/Classify";
...
module.exports = "<div *ngIf=\"isVisible\" class=\"text-analysis-sidebar\">\r\n    <h2>Text Analysis</h2>\r\n\r\n    <div *ngIf=\"sentiment\">\r\n        <h3 class=\"-sf-mt-xs\">Sentiment</h3>\r\n        <div>Polarity: <strong>{{sentiment.Polarity}}</strong> ({{sentiment.polarity_confidence * 100 | number:'1.0'}}%)</div>\r\n        <div>Subjectivity: <strong>{{sentiment.Subjectivity}}</strong> ({{sentiment.subjectivity_confidence * 100 | number:'1.0'}}%)</div>\r\n    </div>\r\n\r\n    <div *ngIf=\"summary\">\r\n        <h3 class=\"-sf-mt-xs\">Suggested Summary</h3>\r\n        <div>{{summary}}</div>\r\n        <button (click)=\"onAddSummary($event)\" class=\"sf-button -circle -small -sf-mb-4xs -icon ng-star-inserted\" title=\"Select\" aria-label=\"Select categories\">\r\n            <i class=\"button__icon sf-icon fa fa-plus -size-xs ng-star-inserted\"></i>\r\n        </button>\r\n    </div>\r\n\r\n    <div *ngIf=\"hashtags && hashtags.length > 0\">\r\n        <h3 class=\"-sf-mt-xs\">Suggested Hashtags</h3>\r\n        <div *ngFor=\"let hashtag of hashtags\">\r\n            {{hashtag}}\r\n            <button (click)=\"onAddTag($event, hashtag)\" class=\"sf-button -circle -small -sf-mb-4xs -icon ng-star-inserted\" title=\"Select\" aria-label=\"Select categories\">\r\n                <i class=\"button__icon sf-icon fa fa-plus -size-xs ng-star-inserted\"></i>\r\n            </button>\r\n        </div>\r\n    </div>\r\n\r\n    <div *ngIf=\"categories && categories.length > 0\">\r\n        <h3 class=\"-sf-mt-xs\">Suggested Categories</h3>\r\n        <div *ngFor=\"let category of categories\">\r\n            {{category.Label}}\r\n            <button (click)=\"onAddCategory($event, category)\" class=\"sf-button -circle -small -sf-mb-4xs -icon ng-star-inserted\" title=\"Select\" aria-label=\"Select categories\">\r\n                <i class=\"button__icon sf-icon fa fa-plus -size-xs ng-star-inserted\"></i>\r\n            </button>\r\n        </div>\r\n    </div>\r\n\r\n    <button (click)=\"onAnalyzeClick()\" class=\"sf-button -action -sf-mt-xs\">Analyze text</button>\r\n</div>";
...
//# sourceMappingURL=text-analysis.extensions.bundle.js.map